...
export default function WalletPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Total Balance hero — Stitch My Wallet V2 */}
      ...
      {/* Quick actions: Add funds / Exchange */}
      ...
      <section className="rounded-xl border border-accent-purple/30 bg-gradient-to-br from-accent-purple/12 via-surface to-surface p-3.5 flex items-start gap-3">
