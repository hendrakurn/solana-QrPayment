...
#[derive(Accounts)]
#[instruction(amount_usdc: u64, amount_idr: u64, merchant_id: String, xendit_reference: String)]
...
pub fn handler(
    ...
    require!(amount_usdc > 0, SolPayError::InvalidAmount);
    ...
    token::transfer_checked(cpi_ctx, amount_usdc, ctx.accounts.usdc_mint.decimals)?;
